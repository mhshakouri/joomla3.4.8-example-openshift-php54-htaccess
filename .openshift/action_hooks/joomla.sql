...
--
-- Host: localhost:3306
-- Generation Time: Jan 22, 2016 at 07:10 AM
...
INSERT INTO `sfj8s_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
INSERT INTO `sfj8s_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
...
INSERT INTO `sfj8s_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
...
(655, 'Super User', 'admin', 'admin@admin', '$2y$10$1q5Hl.BPcu/WiDubky6pS.0B99LkqVg/PtjrxnE9Ao6Wgx1BSv2rq', 0, 1, '2016-01-22 15:10:03', '0000-00-00 00:00:00', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);
...
--
-- Indexes for table `sfj8s_assets`
--
ALTER TABLE `sfj8s_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `sfj8s_associations`
--
ALTER TABLE `sfj8s_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indexes for table `sfj8s_banners`
--
ALTER TABLE `sfj8s_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `sfj8s_banner_clients`
--
ALTER TABLE `sfj8s_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`);

--
-- Indexes for table `sfj8s_banner_tracks`
--
ALTER TABLE `sfj8s_banner_tracks`
...
--
-- Indexes for table `sfj8s_categories`
--
ALTER TABLE `sfj8s_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `sfj8s_contact_details`
--
ALTER TABLE `sfj8s_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indexes for table `sfj8s_content`
--
ALTER TABLE `sfj8s_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `sfj8s_contentitem_tag_map`
--
ALTER TABLE `sfj8s_contentitem_tag_map`
...
--
-- Indexes for table `sfj8s_content_frontpage`
--
ALTER TABLE `sfj8s_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `sfj8s_content_rating`
--
ALTER TABLE `sfj8s_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `sfj8s_content_types`
--
ALTER TABLE `sfj8s_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`);

--
-- Indexes for table `sfj8s_extensions`
--
ALTER TABLE `sfj8s_extensions`
...
--
-- Indexes for table `sfj8s_finder_filters`
--
ALTER TABLE `sfj8s_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `sfj8s_finder_links`
--
ALTER TABLE `sfj8s_finder_links`
...
--
-- Indexes for table `sfj8s_finder_links_terms0`
--
ALTER TABLE `sfj8s_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `sfj8s_finder_links_terms1`
--
ALTER TABLE `sfj8s_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `sfj8s_finder_links_terms2`
--
ALTER TABLE `sfj8s_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `sfj8s_finder_links_terms3`
--
ALTER TABLE `sfj8s_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `sfj8s_finder_links_terms4`
--
ALTER TABLE `sfj8s_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `sfj8s_finder_links_terms5`
--
ALTER TABLE `sfj8s_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `sfj8s_finder_links_terms6`
--
ALTER TABLE `sfj8s_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `sfj8s_finder_links_terms7`
--
ALTER TABLE `sfj8s_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `sfj8s_finder_links_terms8`
--
ALTER TABLE `sfj8s_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `sfj8s_finder_links_terms9`
--
ALTER TABLE `sfj8s_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `sfj8s_finder_links_termsa`
--
ALTER TABLE `sfj8s_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `sfj8s_finder_links_termsb`
--
ALTER TABLE `sfj8s_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `sfj8s_finder_links_termsc`
--
ALTER TABLE `sfj8s_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `sfj8s_finder_links_termsd`
--
ALTER TABLE `sfj8s_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `sfj8s_finder_links_termse`
--
ALTER TABLE `sfj8s_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `sfj8s_finder_links_termsf`
--
ALTER TABLE `sfj8s_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `sfj8s_finder_taxonomy`
--
ALTER TABLE `sfj8s_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `sfj8s_finder_taxonomy_map`
--
ALTER TABLE `sfj8s_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indexes for table `sfj8s_finder_terms`
--
ALTER TABLE `sfj8s_finder_terms`
...
--
-- Indexes for table `sfj8s_finder_terms_common`
--
ALTER TABLE `sfj8s_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indexes for table `sfj8s_finder_tokens`
--
ALTER TABLE `sfj8s_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indexes for table `sfj8s_finder_tokens_aggregate`
--
ALTER TABLE `sfj8s_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indexes for table `sfj8s_finder_types`
--
ALTER TABLE `sfj8s_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indexes for table `sfj8s_languages`
--
ALTER TABLE `sfj8s_languages`
...
--
-- Indexes for table `sfj8s_menu`
--
ALTER TABLE `sfj8s_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `sfj8s_menu_types`
--
ALTER TABLE `sfj8s_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indexes for table `sfj8s_messages`
--
ALTER TABLE `sfj8s_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indexes for table `sfj8s_messages_cfg`
--
ALTER TABLE `sfj8s_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indexes for table `sfj8s_modules`
--
ALTER TABLE `sfj8s_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `sfj8s_modules_menu`
--
ALTER TABLE `sfj8s_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `sfj8s_newsfeeds`
--
ALTER TABLE `sfj8s_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indexes for table `sfj8s_overrider`
--
ALTER TABLE `sfj8s_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sfj8s_postinstall_messages`
--
ALTER TABLE `sfj8s_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `sfj8s_redirect_links`
--
ALTER TABLE `sfj8s_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_link_old` (`old_url`),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indexes for table `sfj8s_schemas`
--
ALTER TABLE `sfj8s_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indexes for table `sfj8s_session`
--
ALTER TABLE `sfj8s_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `userid` (`userid`),
  ADD KEY `time` (`time`);

--
-- Indexes for table `sfj8s_tags`
--
ALTER TABLE `sfj8s_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `sfj8s_template_styles`
--
ALTER TABLE `sfj8s_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Indexes for table `sfj8s_ucm_base`
--
ALTER TABLE `sfj8s_ucm_base`
...
--
-- Indexes for table `sfj8s_ucm_content`
--
ALTER TABLE `sfj8s_ucm_content`
...
--
-- Indexes for table `sfj8s_ucm_history`
--
ALTER TABLE `sfj8s_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indexes for table `sfj8s_updates`
--
ALTER TABLE `sfj8s_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indexes for table `sfj8s_update_sites`
--
ALTER TABLE `sfj8s_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `sfj8s_update_sites_extensions`
--
ALTER TABLE `sfj8s_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `sfj8s_usergroups`
--
ALTER TABLE `sfj8s_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `sfj8s_users`
--
ALTER TABLE `sfj8s_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `sfj8s_user_keys`
--
ALTER TABLE `sfj8s_user_keys`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `sfj8s_user_notes`
--
ALTER TABLE `sfj8s_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indexes for table `sfj8s_user_profiles`
--
ALTER TABLE `sfj8s_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indexes for table `sfj8s_user_usergroup_map`
--
ALTER TABLE `sfj8s_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `sfj8s_viewlevels`
--
ALTER TABLE `sfj8s_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `sfj8s_assets`
--
ALTER TABLE `sfj8s_assets`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=54;
--
-- AUTO_INCREMENT for table `sfj8s_banners`
--
ALTER TABLE `sfj8s_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sfj8s_banner_clients`
--
ALTER TABLE `sfj8s_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sfj8s_categories`
--
ALTER TABLE `sfj8s_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `sfj8s_contact_details`
--
ALTER TABLE `sfj8s_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sfj8s_content`
--
ALTER TABLE `sfj8s_content`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sfj8s_content_types`
--
ALTER TABLE `sfj8s_content_types`
  MODIFY `type_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT for table `sfj8s_extensions`
--
ALTER TABLE `sfj8s_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT for table `sfj8s_finder_filters`
--
ALTER TABLE `sfj8s_finder_filters`
  MODIFY `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sfj8s_finder_links`
--
ALTER TABLE `sfj8s_finder_links`
  MODIFY `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sfj8s_finder_taxonomy`
--
ALTER TABLE `sfj8s_finder_taxonomy`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `sfj8s_finder_terms`
--
ALTER TABLE `sfj8s_finder_terms`
  MODIFY `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sfj8s_finder_types`
--
ALTER TABLE `sfj8s_finder_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sfj8s_languages`
--
ALTER TABLE `sfj8s_languages`
  MODIFY `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `sfj8s_menu`
--
ALTER TABLE `sfj8s_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=102;
--
-- AUTO_INCREMENT for table `sfj8s_menu_types`
--
ALTER TABLE `sfj8s_menu_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `sfj8s_messages`
--
ALTER TABLE `sfj8s_messages`
  MODIFY `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sfj8s_modules`
--
ALTER TABLE `sfj8s_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=87;
--
-- AUTO_INCREMENT for table `sfj8s_newsfeeds`
--
ALTER TABLE `sfj8s_newsfeeds`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sfj8s_overrider`
--
ALTER TABLE `sfj8s_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT for table `sfj8s_postinstall_messages`
--
ALTER TABLE `sfj8s_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `sfj8s_redirect_links`
--
ALTER TABLE `sfj8s_redirect_links`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sfj8s_tags`
--
ALTER TABLE `sfj8s_tags`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `sfj8s_template_styles`
--
ALTER TABLE `sfj8s_template_styles`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `sfj8s_ucm_content`
--
ALTER TABLE `sfj8s_ucm_content`
  MODIFY `core_content_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sfj8s_ucm_history`
--
ALTER TABLE `sfj8s_ucm_history`
  MODIFY `version_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sfj8s_updates`
--
ALTER TABLE `sfj8s_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sfj8s_update_sites`
--
ALTER TABLE `sfj8s_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `sfj8s_usergroups`
--
ALTER TABLE `sfj8s_usergroups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `sfj8s_users`
--
ALTER TABLE `sfj8s_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=656;
--
-- AUTO_INCREMENT for table `sfj8s_user_keys`
--
ALTER TABLE `sfj8s_user_keys`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sfj8s_user_notes`
--
ALTER TABLE `sfj8s_user_notes`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sfj8s_viewlevels`
--
ALTER TABLE `sfj8s_viewlevels`
